...
|---|---|---|
| P0 sub-tab switching white-screens / reloads | PARTIAL_REQA | Current Mac evidence covers Home default->popular and Toplist all->year without terminal empty/no-more copy. Favorites favcat/order, site switch, and Search/filter remain open; Search/Favorites were blocked by the system Xiaoyi IME first-run privacy page in this run. |
