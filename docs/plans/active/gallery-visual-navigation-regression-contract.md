...
| P1 gallery cover presentation | PARTIAL_REQA | Current Mate X7 evidence covers loaded/light detail header, loaded/light Home default list, loaded/light Home grid-card intentional-cover behavior, loaded/dark Home default list, and loaded/dark detail header. Loading, error, dark grid-card, and controller visual acceptance remain open. |
