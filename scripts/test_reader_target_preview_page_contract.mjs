...
ok('Reader seeds loaded preview page markers for contiguous all-thumbnails seed', /for \(let p: number = 0; p < seedLoadedPages; p\+\+\)[\s\S]*this\.loadedPreviewPages\.push\(p\)/.test(vmSrc))
