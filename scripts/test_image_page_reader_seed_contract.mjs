...
ok('Reader image page keeps fast path for pre-resolved imageUrl', /this\.image\.imageUrl\.length > 0[\s\S]*this\.imageUrl = this\.image\.imageUrl/.test(readerImagePageSrc))
