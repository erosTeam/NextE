...
assert(
  /pushPathByName\('EhSettings'[\s\S]*pushPathByName\('LayoutSettings'[\s\S]*pushPathByName\('ReaderSettings'[\s\S]*pushPathByName\('DownloadSettings'[\s\S]*pushPathByName\('SearchSettings'[\s\S]*pushPathByName\('History'[\s\S]*pushPathByName\('CacheSettings'[\s\S]*pushPathByName\('AdvancedSettings'/.test(settings),
  'normal settings order must stay EH -> Layout -> Reader -> Download -> Search -> History -> Cache -> Advanced',
)
